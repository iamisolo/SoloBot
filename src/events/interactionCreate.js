    ...
    try {
      ...
      if (interaction.isButton()) {
        ...
        if (interaction.customId === "gw_join") {
          ...
          for (const value of data.entries.values()) {
            count += value;
          }
      ...
      if (interaction.isStringSelectMenu()) {
        ...
        const all =
          interaction.component.options.map(
            o => o.value
          );
